    ...
    <div style='max-width:420px;margin:80px auto;padding:40px;
        ...
        <div style='text-align:center;margin-bottom:32px'>
            <div style='background:#0f1b3d;border-radius:12px;padding:20px 28px;margin-bottom:20px;display:inline-block'>
                <img src="data:image/png;base64,{LOGIN_LOGO_B64}" style='height:56px;width:auto;filter:brightness(0) invert(1);display:block'>
            </div>
